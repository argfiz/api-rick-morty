...
///////RESALTAR SOLO PERSONAJE EN MENU
	
/*let p = document.querySelector("#id-personaje")
	p.addEventListener("click" , function() {

		this.style.color="red"
		p.classList.add("resaltado")

		alert("tocaron el link personaje")
...
/*
var ajaxRequest = new XMLHttpRequest(); 	//instancio un objeto de clase XMLHttpRequest() en la variable
ajaxRequest.onreadystatechange = funcion() {     //Verificar que consulta salga ok
	if (ajaxRequest.readyState == 4 && ajaxRequest.status == 200){ 
		document.getElementById("resultado2").innerHTML = ajaxRequest.responseText;
	}
	};		

ajaxRequest.open("GET", "documento.text", true); //mostrar el archivo de texto
ajaxRequest.send();
